...
public class RSAService {
    private static Logger log = LoggerFactory.getLogger(RSAService.class);
     ...
     */
    public Result<KeyPair> generateKeyPair() {
        try {
    ...
    public Result<String> decryptPwd(HttpServletRequest request, String cryptograph) {
        ...
        if (!ret.success()) {
            ...
            return Result.returnError("decryptPwd failed:" + ret.msg());
        }
