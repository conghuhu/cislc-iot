...
public class KeyPairGenUtil {
    ...
    private static void genKeyPair() throws NoSuchAlgorithmException {
        ...
        String publicKeyBase64 = Arrays.toString(Base64.getEncoder().encode(publicKeyBytes));
        String privateKeyBase64 = Arrays.toString(Base64.getEncoder().encode(privateKeyBytes));
